...
Levels are loaded using svg file format. 

 Collisioion system is done by adding raycast to the engine.

Some of the patterns used are Observer pattern, command etc..

In summary this engine is made to easily make 2D games, which still can be improved a lot in the future.
