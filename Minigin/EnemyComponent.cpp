...
//if (enemyCenter.x <= playerCenter.x)
//{
//	bool checkMovementUpDown = false;
//	if (m_enemyState != EnemyStates::movingLeft)
//	{
//		//auto tempCurrentState = m_enemyState;
//		m_enemyState = EnemyStates::movingRight;
//		if (!checkIfMovementIsPossible(m_enemyState))
//		{
//			checkMovementUpDown = true;
//		}
//	}
//
//	if (checkMovementUpDown)
//	{
//		if (enemyCenter.y - playerCenter.y >= 2.f)
//		{
//			auto tempCurrentState = m_enemyState;
//			//move down
//			m_enemyState = EnemyStates::movingDown;
...
//			if (!checkIfMovementIsPossible(m_enemyState))
//			{
//				m_enemyState = tempCurrentState;
//			}
//			//m_DestRect.bottom += 20 * elapsedSec;
//		}
//		else if (playerCenter.y - enemyCenter.y >= 2.f)
//		{
//			//move up
//			auto tempCurrentState = m_enemyState;
//			m_enemyState = EnemyStates::movingUp;
...
//			checkMovementUpDown = true;
//		}
//		// check if it can move up or down else keep moving left
//		if (checkMovementUpDown)
//		{
//			if (enemyCenter.y - playerCenter.y >= 2.f)
//			{
...
//	}
//	//m_DestRect.left -= 20 * elapsedSec;
//	else if (enemyCenter.y - playerCenter.y >= 2.f)
//	{
//		//move doww
//		m_enemyState = EnemyStates::movingDown;
//		//m_Velocity.y = -m_MoveSpeed;
