...
void ButtonManager::AddButton(std::shared_ptr<dae::GameObject>& button)
{
...
std::shared_ptr<ButtonComponent> ButtonManager::GetActiveButtonComp()
{
	...
	auto a = m_Buttons[m_CurrentIdx]->GetComponent<ButtonComponent>();
	return std::make_shared<ButtonComponent>(*a);
}
